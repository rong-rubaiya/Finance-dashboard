export const DASHBOARD_DATA = {
  ...
  analytics: {
    monthlyTrend: [
      { day: '01', income: 400, expenses: 240 },
      { day: '05', income: 1500, expenses: 1100 },
      { day: '10', income: 1200, expenses: 1400 },
      { day: '15', income: 2000, expenses: 800 },
      { day: '20', income: 2500, expenses: 1600 },
      { day: '25', income: 2200, expenses: 1200 },
      { day: '30', income: 3000, expenses: 500 }
    ],
    categories: [
      { name: 'Accommodation', value: 650, color: '#3b82f6' },
      { name: 'Shopping', value: 400, color: '#f59e0b' },
      { name: 'Food', value: 300, color: '#10b981' },
      { name: 'Entertainment', value: 206, color: '#ec4899' }
    ]
  },
  transactions: [
